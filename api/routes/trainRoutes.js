...
import { EditImplementedProgram, addImplementedProgram, deleteImplementedProgram, getAllImplementedProgram, getImplementedProgram } from "../Controllers/implementedProgramController.js";
...
router.delete("/deleteIncludedProgram", deleteIncludedProgramController);
...
router.get("/getAllRegistrationOfTrainee", getAllRegistrationOfTrainee);
...
router.delete("/deleteRegistrationOfTrainee", deleteRegistrationOfTrainee);
